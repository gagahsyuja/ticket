    ...
    <div class="max-w-7xl mx-auto py-8 px-6">
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                ...
                <form action="{{ route('lokasi.update', $lokasi) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_lokasi" value="{{ old('nama_lokasi', $lokasi->nama_lokasi) }}" class="input input-bordered w-full @error('nama_lokasi') input-error @enderror" required>
                            @error('nama_lokasi')
