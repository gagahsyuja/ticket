    ...
    <div class="max-w-7xl mx-auto py-8 px-6">
        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                @php $relatedPrice = $relatedEvent->tikets->min('harga'); @endphp
                <x-event-card :title="$relatedEvent->judul" :date="$relatedEvent->tanggal_waktu" :location="$relatedEvent->lokasi->nama_lokasi" :price="$relatedPrice" :image="$relatedEvent->gambar" :href="route('events.show', $relatedEvent)" />
                @endforeach
            </div>
        </div>
        @endif
